...
import objectDomNode from './domNode';
import objectLength from './length';
import objectArrayLike from './arrayLike';
...
export const isDomNode = objectDomNode;
export const isLength = objectLength;
export const isArrayLike = objectArrayLike;
